...
@section('content')
    <x-ui.page-header 
        ...
        :actions="[
            '<a href=\"' . route('erp.raw-materials.show', $rawMaterial) . '\" class=\"inline-flex items-center gap-2 px-4 py-2 border border-gray-300 text-gray-700 rounded-lg hover:bg-gray-50 transition-colors\"><x-heroicon-o-arrow-left class=\"h-5 w-5\" />Back</a>'
        ]"
    />
    ...
    <div class="max-w-4xl">
        <x-ui.card>
            <form method="POST" action="{{ route('erp.raw-materials.update', $rawMaterial) }}">
                ...
                <div class="mb-8">
                    <h3 class="text-lg font-semibold text-gray-900 mb-4 flex items-center gap-2">
                        <x-heroicon-o-tag class="h-5 w-5 text-blue-600" />
                        Attributes
                    </h3>
